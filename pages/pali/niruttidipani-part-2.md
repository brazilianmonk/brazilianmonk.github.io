    ...
    - sarādesa - 7 types (more on previous semester)
      - i-v + s ⇒ y + s (ityapi) u-v + s ⇒ v + s (svākkhāto) (37. yavā sare)
        ...
        - i-v + s ⇒ y + s note: this ādesa is usually followed by other replacements such as ty ⇒ cc (under byañjanādesa)
          ...
          - senāpatītyāhaṃ ⇒ senāpatīti + ahaṃ (I, as the general)
          - ityeke ⇒ iti + eke (thus, some people)
          - ityattha ⇒ iti + attha (thus, here)
      ...
      - st: e + a ⇒ y + a (myāyaṁ) o + s ⇒ v + s (kvattho) (38. eonaṁ)
        ...
        - e + a ⇒ y + a
          ...
          - tyassa ⇒ te + assa
          - tyāhaṃ ⇒ te + ahaṃ (them, I) (with vuddhi)
          - pabbatyāhaṃ ⇒ pabbate + ahaṃ (I, in the mountain)
          - kyassa ⇒ ke + assa (who, to him)
        - o + s ⇒ v + s
  ...
  - mem aid:
    ...
    - other mnemonics:
      - k kh g gh ṅ c ch j jh ñ ṭ ṭh ḍ ḍh (ṇ) ('t' 'th' d dh 'n') p ph b bh m y ('r') l (v) s h ḷ ṁ
        ...
        - red: appavidhāna
      - k ⇒ kh, d kh ⇒ g g ⇒ k gh ⇒ h c ⇒ ch ch ⇒ s j ⇒ y ñ ⇒ ṇ t ⇒ th, n d ⇒ ḍ, ḷ, t dh ⇒ d, h p ⇒ ph m ⇒ p y ⇒ v l ⇒ r
      - khagga kuha deceitful horn / sword
      ...
      - vicchā 55. vicchābhikkhaññesu dve
        ...
        - what are the 3 categories of what is spread by vicchā (3 types of vicchā)?
          ...
          - note:
            ...
            - māse māse kusaggena, bālo bhuñjetha bhojanaṃ (dhammapada)
            - pade pade vikaṅkheyya, vane andhagajo yathā (moggallānapañcikāṭīkā)
...
- Note:
  - 60. bahulaṃ
    - in most places, there is no one fixed way of forming a sandhi
    - most rules‒not only sandhi rules‒have exceptions, so the rules are made by grammarians to show what is most common in the language
