...
<head>
    ...
    <style>
        ...
        #lang-en:checked ~ .lang-en-content,
        #lang-es:checked ~ .lang-es-content,
        #lang-fr:checked ~ .lang-fr-content {
            display: block;
        }
    </style>
</head>
...
<input type="radio" name="lang" id="lang-en"> English
<input type="radio" name="lang" id="lang-es"> Español
<input type="radio" name="lang" id="lang-fr"> Português

<!-- Write in Markdown! -->
<div class="lang-en-content lang-content">
    <div class="markdown">
## 🇬🇧 English
    </div>
</div>

<div class="lang-es-content lang-content">
    <div class="markdown">
## 🇪🇸 Español
    </div>
</div>
...
<script>
    // Convert all Markdown to HTML when page loads
